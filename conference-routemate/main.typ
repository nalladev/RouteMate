...
+ *Dependence on Commercial Fleet Models* – Most existing ride-sharing systems are designed primarily for commercial taxi or fleet-based operations, limiting participation from private vehicle owners and reducing community-driven mobility opportunities.
...
+ *Absence of Sustainability-Centered Incentives* – Most current solutions emphasize cost-sharing and operational efficiency but do not incorporate structured reward mechanisms such as fuel-saving benefits or carbon emission reduction incentives to encourage environmentally responsible travel behavior.
...
- Encourages environmentally responsible behavior through a structured eco-reward and carbon-saving incentive system.
- Enhances user safety through secure authentication, rating systems, and monitoring mechanisms.
- Reduces traffic congestion and fuel consumption by improving private vehicle seat utilization.
